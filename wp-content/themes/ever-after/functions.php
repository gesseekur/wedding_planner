...
function everafter_fonts() {
	wp_enqueue_style( 'everafter-pacifico', "https://fonts.googleapis.com/css?family=Pacifico" );
	wp_enqueue_style( 'everafter-volkorn',  "https://fonts.googleapis.com/css?family=Vollkorn:400italic,700italic,400,700" );
	wp_enqueue_style( 'everafter-oswald',   "https://fonts.googleapis.com/css?family=Oswald:400,700,300" );
}
